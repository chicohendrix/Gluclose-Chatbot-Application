...
export default function ChatScreen({ navigation }) {
  ...
  function fetchFile(index) {
    ...
    if (index[0].value == "end-conversation.js") {
      (endconversation[0].text === 'No problem, thank you for talking to me, gluclose is always there to help') ? setMessages(endconversation.reverse()) : setMessages(endconversation)
    }
      ...
      <View style={styles.container}>
        ...
        <View style={styles.messageContainer}>
          <GiftedChat
            ...
            quickReplyStyle={{backgroundColor: '#a0cfe8',}}
