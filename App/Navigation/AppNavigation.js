...
function DrawerStack() {
    return (
        <Drawer.Navigator initialRouteName="Chat">
             ...
             */}
            <Drawer.Screen name="About Us" component={AssistanceLinksScreen} />
            <Drawer.Screen name="Help" component={LegalDisclosureScreen} />
            <Drawer.Screen name="Privacy Policy" component={LegalDisclosureScreen} />
            <Drawer.Screen name="Settings" component={LegalDisclosureScreen} />
